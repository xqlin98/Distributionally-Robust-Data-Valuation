...
names = ['Resnet-18', 'VGG11']
metric_idx = metric_dict[args.metric]

path_names = ["NN/cifar10-numdp-2000-seed-1-model-RESNET18-epoch-100-lr-0.05-epsilon-100.0-evaldp-1000--allbaseline.npz",
              "NN/cifar10-numdp-2000-seed-1-model-RESNET18-epoch-100-lr-0.05-epsilon-100.0-evaldp-1000--allbaseline.npz"]
...
for j, name in enumerate(names):
    ...
    len_score = result_1['drge_deviation_score_m'].shape[1]
    ...
    magnitude_se = 0.5
    baseline_names = ["Deviation", "LOO", "Influence", "Tack-in", "Lava", "Davinz", "Random"]
...
figs.text(0.5, 0.04, '$\#$ data points removed', ha='center')
figs.set_figwidth(4.0)
plt.legend(loc="lower right", prop={'size': 8})

plt.savefig(f'figs/dataremoving_larger_nn-{args.metric}.pdf', bbox_inches="tight")
...
plt.savefig(f'figs/dataremoving_larger_nn_l2h-{args.metric}.pdf', bbox_inches="tight")
