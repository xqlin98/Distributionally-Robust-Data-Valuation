...
parser.add_argument('--step', type=int, default=35, help='')
parser.add_argument('--legend', type=int, default=1, help='')
...
path_names = ["NN/housing-numdp-3000-seed-1-model-MLP_REGRESSION_S-epsilon-5-evaldp-1000--allbaseline.npz",
              ...
              "NN/cifar10-numdp-2000-seed-1-model-CNN-epsilon-5-evaldp-1000-cluster_100-allbaseline.npz"
...
# if args.legend:
#     figs.legend(all_handles, baseline_names,loc='lower center', ncol=len(baseline_names), bbox_to_anchor=(0.5, -0.13))
# Adjust the layout to accommodate the legend
# plt.subplots_adjust(bottom=0.2)

if args.selected:
    plt.savefig(f'figs/dataremoving_nn-{args.metric}-selected.pdf', bbox_inches="tight")
else:
    plt.savefig(f'figs/dataremoving_nn-{args.metric}.pdf', bbox_inches="tight")

# Save the legend as a separate figure
legend_fig = plt.figure()
legend_ax = legend_fig.add_subplot(111)
legend_ax.axis('off')
legend_fig.legend(all_handles, baseline_names, loc='center', ncol=len(baseline_names))
legend_fig.set_figheight(0.3)
legend_fig.set_figwidth(10.0)
legend_fig.tight_layout()

legend_fig.savefig('figs/legend_figure.pdf')
...
# plt.subplots_adjust(bottom=0.2)
if args.selected:
    plt.savefig(f'figs/dataremoving_nn_l2h-{args.metric}-selected.pdf', bbox_inches="tight")
else:
    plt.savefig(f'figs/dataremoving_nn_l2h-{args.metric}.pdf', bbox_inches="tight")
