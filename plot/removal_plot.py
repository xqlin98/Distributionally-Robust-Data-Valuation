...
names = ['HOUSING', 'UBER', 'DIABETES', 'MNIST', 'CIFAR-10']
metric_idx = metric_dict[args.metric]

# path_names = ["NN/housing-numdp-3000-seed-1-model-MLP_REGRESSION_S-epsilon-5-evaldp-1000--allbaseline.npz",
#             #   "NN/credit_card-numdp-3000-seed-1-model-MLP_REGRESSION_S-epsilon-5-evaldp-2000-allbaseline.npz",
#               "NN/uber_lyft-numdp-1000-seed-1-model-MLP_REGRESSION_S-epsilon-5-evaldp-900--allbaseline.npz",
#               "NN/diabetes-numdp-4000-seed-1-model-MLP_REGRESSION_S-epsilon-5-evaldp-2000--allbaseline.npz",
#               "NN/mnist-numdp-2000-seed-1-model-CNN-epsilon-5-evaldp-1000--allbaseline.npz",
#               "NN/cifar10-numdp-2000-seed-1-model-CNN-epsilon-5-evaldp-1000--allbaseline.npz"]

path_names = ["Kernel_Regression/housing-numdp-3000-seed-1-length_scale-2.0-epsilon-5-mu-0.01-evaldp-1000-allbaselinev1.npz",
              "Kernel_Regression/uber_lyft-numdp-1500-seed-1-length_scale-3.0-epsilon-5-mu-0.01-evaldp-1000-allbaselinev1.npz",
              "Kernel_Regression/diabetes-numdp-4000-seed-1-length_scale-10.0-epsilon-5-mu-0.01-evaldp-2000-allbaselinev1.npz",
              "Kernel_Regression/mnist-numdp-1000-seed-1-length_scale-50.0-epsilon-10.0-mu-0.0-evaldp-900-allbaselinev1.npz",
            #   "Kernel_Regression/cifar10-numdp-1000-seed-1-length_scale-600.0-epsilon-10.0-mu-0.0005-evaldp-900-allbaselinev1.npz",
              "Kernel_Regression/cifar10-numdp-1000-seed-1-length_scale-600.0-epsilon-10.0-mu-0.0005-evaldp-900-cluster_500.npz"]

if args.metric == 'acc':
    names = ['MNIST', 'CIFAR-10']
    path_names = path_names[3:]

# if args.metric == 'loss':
#     names = ['HOUSING', 'MNIST', 'CIFAR-10']
#     path_names = [path_names[0], path_names[3], path_names[4]]
if args.selected:
    names = ['HOUSING', 'MNIST', 'CIFAR-10']
    path_names = [path_names[0], path_names[3], path_names[4]]
...
if args.selected:
    plt.savefig(f'figs/dataremoving-{args.metric}-selected.pdf', bbox_inches="tight")

else:
    plt.savefig(f'figs/dataremoving-{args.metric}.pdf', bbox_inches="tight")
